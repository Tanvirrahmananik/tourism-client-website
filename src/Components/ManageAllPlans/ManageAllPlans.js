...
const ManageAllPlans = () => {
    ...
    useEffect(() => {
        fetch("https://guarded-dawn-00834.herokuapp.com/managePlans")
        .then(res => res.json())
        .then(data => setOrders(data))
    },[control])

    const handleUpdate = (id) =>{
      fetch(`https://guarded-dawn-00834.herokuapp.com/updateStatus/${id}`, {
        method: "PUT",
    ...
    const handleDelete = (id)=>{
      ...
      if(proceed){
       fetch(`https://guarded-dawn-00834.herokuapp.com/deteteOrders/${id}`, {
           method: 'DELETE'
       })
       .then(res => res.json())
       .then(data =>{
